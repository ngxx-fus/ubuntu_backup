...
###########################################################################
#. /home/msnp/esp/esp-idf/export.sh
#clear
##########################################################################
...
################# Auto Activate VENV Python ######################
# source /mnt/sda2/VENV/venv/bin/activate

################ Oh-my-posh Startup #############################
export PATH=$PATH:/home/msnp/.local/bin
eval "$(oh-my-posh init bash --config /mnt/sda2/Long-term-stored/OH-MY-POSH/theme.json)"

#################################################################
alias venv_bin='cd /mnt/sda2/VENV/venv/bin'
